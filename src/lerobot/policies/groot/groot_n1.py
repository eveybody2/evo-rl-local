...
class GR00TN15Config(PretrainedConfig):
    model_type: str = "gr00t_n1_5"  # 建议显式标注类型

    # 增加 default=None 以解决顺序问题
    ...
    def __init__(self, **kwargs):
        # 注意：PretrainedConfig 通常不需要 super().__init__(**kwargs) 这样手动处理
        # 如果是继承自 transformers.PretrainedConfig，直接调用 super().__init__() 即可
