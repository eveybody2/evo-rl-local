...
class TTYKeyboardListener:
    ...
    def _handle_key(self, key: str):
        ...
        # 增加：监听 TTY 下的 1、2、3
            ...
            subtask_val = int(normalized)
            print(f"'{normalized}' key pressed. Setting subtask to {subtask_val}...")
            self.events["subtask"] = subtask_val
        ...
        def on_press(key):
            try:
                ...
                # 增加：监听按键 1、2、3
                    ...
                    subtask_val = int(key.char)
                    print(f"'{key.char}' key pressed. Setting subtask to {subtask_val}...")
                    events["subtask"] = subtask_val
            except Exception as e:
